...
-- Dumping database structure for mydnd-db
CREATE DATABASE IF NOT EXISTS `mydnd-db` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `mydnd-db`;

-- Dumping structure for table mydnd-db.sys_department
...
-- Dumping structure for table mydnd-db.sys_department_user
...
-- Dumping structure for table mydnd-db.sys_dictionary
...
-- Dumping structure for table mydnd-db.sys_dictionary_item
...
-- Dumping structure for table mydnd-db.sys_message_content
...
-- Dumping structure for table mydnd-db.sys_message_receiver
...
-- Dumping structure for table mydnd-db.sys_message_sender
...
-- Dumping structure for table mydnd-db.sys_region
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8 COMMENT ='系统地区表。';

-- Data exporting was unselected.

-- Dumping structure for table mydnd-db.sys_resource
...
-- Dumping structure for table mydnd-db.sys_role
...
-- Dumping structure for table mydnd-db.sys_role_resource
...
-- Dumping structure for table mydnd-db.sys_user
...
-- Dumping structure for table mydnd-db.sys_user_role
